# Steve Jobs in the Era of AI

A 3,600-batch, repository-driven journey from AI beginner to foundation-model and AI-product builder.
...
- Code, notes, experiments, tests, and evidence belong in the repository.
- Later batches may be readjusted when earlier work exposes a better build order.
...
- `research/` - papers, reproductions, ablations, and experiments.
- `models/` - model implementations and checkpoints metadata.
- `evals/` - evaluation suites and benchmark work.
- `infra/` - training, inference, GPU, distributed, and deployment work.

## Current State

- Completed core batches: **4 / 3,600**
